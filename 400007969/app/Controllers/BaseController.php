...
abstract class BaseController
{
  ...
  public function __construct(?IValidator $validator = null)
  {
    ...
    $this->database = new Database(Config::getDatabaseHost(), Config::getDatabasePort(), Config::getDatabaseUsername(), Config::getDatabasePassword(), Config::getDatabaseName());
  }
  ...
  {
    if (!$this->validator) {
      trigger_error('No validation class is available for the `' . get_called_class() . '` . This means that the user input will not be validated.', E_USER_WARNING);
      return false;
    }
